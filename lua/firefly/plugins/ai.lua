...
require('avante').setup({
    ...
    behaviour = {
        ...
        auto_set_keymaps = true, -- NOTE Without no key maps would work from the config
    ...
    providers = {
        ["owui/gpt-4o-mini"] = {
            ...
            endpoint = "https://ai.infra.shared-k8s.de.clara.net/api",
            display_name = "owui/gpt-4o-mini",
            model = "gpt-4o-mini",
            api_key_name = "OWUI_API_KEY",
            timeout = 30000,
            extra_request_body = {
                temperature = 0.75,
                max_tokens = 16384,
